...
test(
  ...
  async ({ page }) => {
    await page.setViewportSize(DESKTOP);
    await gotoSeeded(page, "/lyrics", multiEntryFixture);
...
test(
  ...
  async ({ page }) => {
    ...
    await gotoSeeded(page, "/lyrics/fixture-multi-msg-3a", multiMessageFixture);
...
test(
  ...
  async ({ page }) => {
    ...
    await gotoSeeded(page, "/lyrics/fixture-multi-msg-1a", multiMessageFixture);
...
test(
  ...
  async ({ page }) => {
    ...
    await gotoSeeded(
      page,
      "/lyrics/fixture-msg-songs-a/songs",
      songGeneratorFixture
    );
...
test(
  ...
  async ({ page }) => {
    await page.setViewportSize(DESKTOP);
    await gotoSeeded(page, "/pinned", pinnedFixture);
